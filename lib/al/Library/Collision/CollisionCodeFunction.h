...
al::CollisionCodeRelationList* tyrGetCollisionRelationList(const al::CollisionCodeList*, const char*);
...
bool judgeIsBetterCodeName(const al::CollisionCodeList*, const char*, const char*, const char*, const char*);
bool judgeIsBetterCodeNameWithAreaName(const al::CollisionCodeRelationList*, const char*, const char*, const char*, const char*, const char*, const char*);
