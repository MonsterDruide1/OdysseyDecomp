...
float calcDistanceH(const LiveActor* actor, const sead::Vector3f&);
bool isNearV(const LiveActor* actor, const sead::Vector3f&, f32);
float calcDistanceV(const LiveActor* actor, const sead::Vector3f&);
...
float calcDistance(const LiveActor* actor, const LiveActor* target);
float calcDistance(const LiveActor* actor, const sead::Vector3f&);
float calcDistanceV(const LiveActor* actor, const LiveActor* target);
float calcDistanceH(const LiveActor* actor, const LiveActor* target);
float calcDistanceH(const LiveActor* actor, const sead::Vector3f&, const sead::Vector3f&);
float calcHeight(const LiveActor* actor, const LiveActor* target);
