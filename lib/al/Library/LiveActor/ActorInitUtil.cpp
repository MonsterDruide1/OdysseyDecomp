...
__attribute__((always_inline)) inline bool initActorPoseKeeper(const char* pose, LiveActor* actor) {
    if (!pose)
        return false;
    s32 poseId = -1;
    for (s32 i = 0; i < 9; i++) {
...
__attribute__((always_inline)) inline void initActorPose(LiveActor* actor,
...
__attribute__((always_inline)) inline void initActorScale(LiveActor* actor,
                                                          const ActorInitInfo& initInfo,
                                                          Resource* modelRes, const char* suffix) {
    ByamlIter initScale;
...
__attribute__((always_inline)) inline ModelLodCtrl*
...
initActorModel(LiveActor* actor, const ActorInitInfo& initInfo, Resource* modelRes,
               ActorResource* actorResource, const char* suffix) {
    ByamlIter initModel;
...
__attribute__((always_inline)) inline void initActorExecutor(LiveActor* actor,
                                                             const ActorInitInfo& initInfo,
                                                             Resource* modelRes,
                                                             const char* suffix) {
...
__attribute__((always_inline)) inline void initActorSensor(LiveActor* actor,
                                                           const ActorInitInfo& initInfo,
                                                           Resource* modelRes, const char* suffix) {
...
__attribute__((always_inline)) inline void initActorCollision(LiveActor* actor,
                                                              const ActorInitInfo& initInfo,
                                                              Resource* modelRes,
                                                              const char* suffix) {
...
__attribute__((always_inline)) inline void initActorCollider(LiveActor* actor,
                                                             const ActorInitInfo& initInfo,
                                                             Resource* modelRes,
                                                             const char* suffix) {
...
__attribute__((always_inline)) inline void initActorEffect(LiveActor* actor,
                                                           const ActorInitInfo& initInfo,
                                                           Resource* modelRes, const char* suffix) {
...
__attribute__((always_inline)) inline void initActorSound(LiveActor* actor,
                                                          const ActorInitInfo& initInfo,
                                                          Resource* modelRes, const char* suffix) {
    ByamlIter initSound;
...
__attribute__((always_inline)) inline void initActorRail(LiveActor* actor,
                                                         const ActorInitInfo& initInfo) {
    if (isExistRail(initInfo, "Rail"))
        actor->initRailKeeper(initInfo, "Rail");
}

__attribute__((always_inline)) inline void initActorGroupClipping(LiveActor* actor,
                                                                  const ActorInitInfo& initInfo,
...
__attribute__((always_inline)) inline void initActorClipping(LiveActor* actor,
                                                             const ActorInitInfo& initInfo,
                                                             Resource* modelRes,
                                                             const char* suffix) {
...
__attribute__((always_inline)) inline void initActorShadowMask(LiveActor* actor,
                                                               const ActorInitInfo& initInfo,
                                                               Resource* modelRes,
                                                               const char* suffix) {
...
__attribute__((always_inline)) inline void initActorFlag(LiveActor* actor,
                                                         const ActorInitInfo& initInfo,
                                                         Resource* modelRes, const char* suffix) {
    ByamlIter initFlag;
...
__attribute__((always_inline)) inline void initActorItem(LiveActor* actor,
                                                         const ActorInitInfo& initInfo,
                                                         Resource* modelRes, const char* suffix) {
    ByamlIter initItem;
...
__attribute__((always_inline)) inline void initActorScore(LiveActor* actor,
                                                          const ActorInitInfo& initInfo,
                                                          Resource* modelRes, const char* suffix) {
    ByamlIter initScore;
...
__attribute__((always_inline)) inline void
initActorAction(LiveActor* actor, const ActorInitInfo& initInfo, Resource* modelRes,
                ActorResource* actorResource, const char* suffix) {
...
__attribute__((always_inline)) inline LiveActor*
