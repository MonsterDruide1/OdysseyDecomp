...
void DirectionParam::syncToDirection() {
    ...
    f32 latitudeX = -sead::Mathf::cos(getLatitudeRadian());

    mDirection.x = sead::Mathf::sin(getLongitudeRadian()) * latitudeX;
    mDirection.z = sead::Mathf::cos(getLongitudeRadian()) * latitudeX;
}
