...
bool isEqualCharacterId(const nn::nfp::ModelInfo& modelInfo, const NfpCharacterId& characterId) {
    if (characterId.gameId != (u8)modelInfo.characterId)
        return false;

    if (characterId.characterId != modelInfo.characterId >> 8)
        return false;
...
bool tryGetCharacterId(NfpCharacterId* characterId, const NfpInfo& nfpInfo) {
    ...
    characterId->gameId = (u8)nfpInfo.modelInfo.characterId;
    characterId->characterId = (u8)(nfpInfo.modelInfo.characterId >> 8);
...
bool isEqualCharacterIdBase(const nn::nfp::ModelInfo& modelInfo,
    ...
    return characterId.characterId == modelInfo.characterId >> 8;
}
