...
const sead::Vector2f& getLocalTrans(const IUseLayout*);
...
void setPaneStringLength(IUseLayout*, const char*, const char16_t*, u16, u16);
void setPaneString(IUseLayout*, const char*, const char16_t*, u16);
...
const char16_t* getPaneStringBuffer(const IUseLayout*, const char*);
