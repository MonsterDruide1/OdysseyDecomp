...
bool tryFindNearestPlayerDisatanceFromTarget(f32* distance, const LiveActor* actor, const sead::Vector3f& target);
bool isNearPlayer(const LiveActor* actor, f32 threshold);
bool isNearPlayerH(const LiveActor* actor, f32 threshold);
bool isNearPlayerHCondition(const LiveActor* actor, f32 threshold, bool (* condition)(const LiveActor*));
...
LiveActor* tryFindNearestPlayerActorCondition(const LiveActor* actor, bool (* condition)(const LiveActor*));
bool tryFindNearestPlayerPosCondition(sead::Vector3f* pos, const LiveActor* actor,
                                      bool (* condition)(const LiveActor*));
bool isResetablePlayerPos(const LiveActor* actor, const sead::Vector3f& pos, f32 clippingRadius, f32 threshold);
