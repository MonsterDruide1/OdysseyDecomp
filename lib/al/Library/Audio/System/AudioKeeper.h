...
public:
    ...
    char* getStringArgInCurArea(const char*) const;
    char* getStringArgInCurAreaWithAreaCheck(const char*) const;

    s32 getIntArgInPastArea(const char*) const;
    char* getStringArgInPastArea(const char*) const;

    bool tryGetIntArgInCurArea(s32*, const char*) const;
    bool tryGetStringArgInCurArea(const char**, const char*) const;

    virtual AreaObjDirector* getAreaObjDirector() const { return mAreaObjDirector; }
