...
const sead::LookAtCamera& getLookAtCamera(const al::CameraPoser*);
const sead::Projection& getProjectionSead(const al::CameraPoser*);
const al::Projection* getProjection(const al::CameraPoser*);
const sead::Matrix44f& getProjectionMtx(const al::CameraPoser*);
...
f32 calcPreCameraAngleH(const al::CameraPoser*);
f32 calcPreCameraAngleV(const al::CameraPoser*);
