...
void startSeWithMeInfo(const al::IUseAudioKeeper*, const sead::SafeString&, const al::MeInfo*);
void holdSeWithMeInfo(const al::IUseAudioKeeper*, const sead::SafeString&, const al::MeInfo*);
