...
sead::Color4f& getShadowMaskColor(const LiveActor*, const char*);
void setShadowMaskIntensity(const LiveActor*, const char*, f32);
f32 getShadowMaskIntensity(const LiveActor*, const char*);
void* getShadowMaskTextureFixedScale(const LiveActor*, const char*);
void setShadowMaskTextureFixedScale(const LiveActor*, const char*, f32);
sead::Vector3f& getShadowMaskOffset(const LiveActor*, const char*);
