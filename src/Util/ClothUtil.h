...
sead::PtrArrayImpl* getClothList(GameDataHolderAccessor accessor);
...
sead::PtrArrayImpl* getCapList(GameDataHolderAccessor accessor);
...
sead::PtrArrayImpl* getGiftList(GameDataHolderAccessor accessor);
...
sead::PtrArrayImpl* getStickerList(GameDataHolderAccessor accessor);
