...
public:
    ...
    virtual f32 getSpinFlowerJumpDownFallInitSpeed() const { return mSpinFlowerJumpDownFallInitSpeed; }
    virtual f32 getSpinFlowerJumpDownFallPower() const { return mSpinFlowerJumpDownFallPower; }
    virtual f32 getSpinFlowerJumpDownFallSpeedMax() const { return mSpinFlowerJumpDownFallSpeedMax; }
    ...
    virtual f32 getSwimRunSurfaceApproachBorderMax() const { return mSwimRunSurfaceApproachBorderMax; }
    virtual f32 getSwimRunSurfaceApproachBorderMin() const { return mSwimRunSurfaceApproachBorderMin; }
