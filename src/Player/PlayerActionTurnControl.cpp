...
void PlayerActionTurnControl::setup(f32 turnAngleStart, f32 turnAngleFast, f32 turnAngleLimit, f32 turnAngleFastLimit, s32 turnAccelFrame, s32 turnAccelFrameFast, s32 turnBrakeFrame) {
...
void PlayerActionTurnControl::update(const sead::Vector3f& a2, const sead::Vector3f& a3) {
  ...
  if ( v18 || (float)((float)((float)(a3a.x * a1.x) + (float)(a3a.y * a1.y)) + (float)(a3a.z * a1.z)) < 0.34202 )
  {
    this->_44 = 0;
    this->_48 = 0;
    v19 = 0.0;
...
LABEL_21:
  ...
  if ( (v44 & (v15 ^ 1) & 1) == 0 )
  {
    ...
    else
    {
      if ( !v13 )
      {
        ...
        this->_c.z = 0.0;
        this->_18.x = 0.0;
        this->_8 = PlayerActionFunction::brake(this->_8, this->mTurnBrakeFrame, this->mTurnAngleLimit);
        goto LABEL_101;
      }

      al::calcFrontDir(&v98, this->mActor);
      if ( (float)((float)((float)(up.x * v11) + (float)(up.y * (float)-y)) + (float)(up.z * (float)-z)) < 0.0 )
      {
        v98.x = -v98.x;
        v98.y = -v98.y;
        v98.z = -v98.z;
  ...
  if ( v52 >= -1.0 )
  {
    v53 = (float)((float)(front.x * a3a.x) + (float)(front.y * a3a.y)) + (float)(front.z * a3a.z);
    if ( v52 > 1.0 )
      v53 = 1.0;
  }
  ...
  v55 = v50 * 57.296;
  if ( (float)((float)((float)(v97.x * this->_18.x) + (float)(v97.y * this->_18.y)) + (float)(v97.z * this->_18.z)) <= 0.0 )
  {
...
LABEL_62:
  ...
  v56 = &a3;
  if ( (float)((float)((float)(v95.x * v97.x) + (float)(v95.y * v97.y)) + (float)(v95.z * v97.z)) >= 0.0 )
  {
    v57 = 0;
    v58 = 0;
  }
...
LABEL_63:
  v59 = v54 * 57.296;
  v60 = al::calcRate01(
          sqrtf((float)((float)(v51->x * v51->x) + (float)(v51->y * v51->y)) + (float)(v51->z * v51->z)),
          0.0,
          0.8);
  v61 = 0.25;
  if ( v60 >= 0.25 )
...
LABEL_68:
  ...
  v64 = PlayerActionFunction::accel(v63, mTurnAngleFastLimit, mTurnAngleFastLimit / (float)mTurnAccelFrameFast);
...
LABEL_82:
  ...
  if ( v57 || al::isReverseDirection(front, a3a, 0.01) )
  {
    ...
    p_z = &v56->z;
    v71 = v56->z;
    if ( (float)((float)((float)(v97.x * v56->x) + (float)(v97.y * v69)) + (float)(v97.z * v71)) <= 0.0 )
    {
      v67 = -v67;
      v69 = -v69;
      v71 = -v71;
    ...
    v84 = (float)((float)-(float)(v78 * front.x) - (float)(v79 * front.y)) - (float)(front.z * v80);
    v98.x = (float)((float)(v79 * v83) + (float)((float)(v76 * v81) - (float)(v80 * v82))) - (float)(v78 * v84);
    v98.y = (float)((float)((float)(v80 * v81) + (float)(v76 * v82)) - (float)(v78 * v83)) - (float)(v79 * v84);
    v98.z = (float)((float)(v76 * v83) + (float)((float)(v78 * v82) - (float)(v79 * v81))) - (float)(v80 * v84);
  ...
  else
  {
    ...
    v85 = (float)((float)(v95.y * front.z) - (float)(v95.z * front.y)) + (float)(v95.w * front.x);
    v86 = (float)(front.y * v95.w) + (float)((float)(v95.z * front.x) - (float)(front.z * v95.x));
    v87 = (float)(front.z * v95.w) + (float)((float)(front.y * v95.x) - (float)(v95.y * front.x));
    v88 = (float)((float)-(float)(front.x * v95.x) - (float)(v95.y * front.y)) - (float)(front.z * v95.z);
    v98.x = (float)((float)(v95.y * v87) + (float)((float)(v95.w * v85) - (float)(v95.z * v86))) - (float)(v95.x * v88);
    v98.y = (float)((float)((float)(v85 * v95.z) + (float)(v86 * v95.w)) - (float)(v87 * v95.x)) - (float)(v88 * v95.y);
    v98.z = (float)((float)((float)(v86 * v95.x) - (float)(v85 * v95.y)) + (float)(v87 * v95.w)) - (float)(v88 * v95.z);
    al::normalize(&v98);
    ...
    if ( v58 )
    {
      ...
      v90 = v96.y;
      v91 = v96.z;
      if ( (float)((float)((float)(v96.x * this->_18.x) + (float)(v96.y * this->_18.y)) + (float)(v96.z * this->_18.z)) < 0.0 )
      {
        v89 = -v96.x;
        v90 = -v96.y;
        v91 = -v96.z;
...
f32 PlayerActionTurnControl::calcTurnPowerRate(const sead::Vector3f&) const {
    CRASH
}
