...
static sead::Vector3f gVector = {150.0f, 0.0f, 0.0f};
static NpcEventStateScareActionParam gStateScare = {"ScaredStart", "Scared", "ScaredEnd"};
...
void VolleyballNpc::endGame() {
    for (s32 i = 0; i < mBallGroup->getActorCount(); i++)
        mBallGroup->getDeriveActor(i)->set_138(true);
...
// _ZN13VolleyballNpc12exeWaitRetryEv
