...
void BirdPlayerGlideCtrl::init(const al::ActorInitInfo& info) {
    ...
    al::setSceneObj(this, this, SceneObjID_BirdPlayerGlideCtrl);
...
void validateGlideBirdOnPlayerNose(const al::LiveActor* player) {
    if (al::isExistSceneObj(player, SceneObjID_BirdPlayerGlideCtrl))
        al::getSceneObj<BirdPlayerGlideCtrl>(player, SceneObjID_BirdPlayerGlideCtrl)
            ->validateGlideOnNose();
}
...
bool isPlayerSitDownChair(const Bird* bird) {
    return al::isExistSceneObj(bird, SceneObjID_BirdPlayerGlideCtrl) &&
           al::getSceneObj<BirdPlayerGlideCtrl>(bird, SceneObjID_BirdPlayerGlideCtrl)
               ->isValidOnSitDownHead();
}
