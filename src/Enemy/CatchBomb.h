...
public:
    ...
    void exePull();
    bool checkCollisionExplode(const sead::Vector3f&);
    void exeMarch();
    void exeExplode();
    void exeHide();
    void exeAppear();
    void exeThrow();
    void initThrow(const al::ActorInitInfo&);
    void appearThrow(const sead::Vector3f& pos, const sead::Vector3f& vel);
    void control() override;

private:
    LoopAnimState* mLoopAnimState = nullptr;
    al::LiveActor* mSensorHost = nullptr;
