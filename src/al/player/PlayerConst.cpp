...
float PlayerConst::getGravity() const {return mGravity;}
float PlayerConst::getFrictionAttack() const {return mFrictionAttack;}
float PlayerConst::getPushPower() const {return mPushPower;}
float PlayerConst::getWaitPoseDegreeMax() const {return mWaitPoseDegreeMax;}
float PlayerConst::getHillPoseDegreeMax() const {return mHillPoseDegreeMax;}
float PlayerConst::getTiltPoseDegreeMax() const {return mTiltPoseDegreeMax;}
float PlayerConst::getSlerpQuatRate() const {return mSlerpQuatRate;}
float PlayerConst::getSlerpQuatRateWait() const {return mSlerpQuatRateWait;}
float PlayerConst::getSlerpQuatGrav() const {return mSlerpQuatGrav;}
int PlayerConst::getPreInputFrameCapThrow() const {return mPreInputFrameCapThrow;}
int PlayerConst::getEnableActionFrameCapCatch() const {return mEnableActionFrameCapCatch;}
float PlayerConst::getJumpPowerCapCatch() const {return mJumpPowerCapCatch;}
float PlayerConst::getJumpGravityCapCatch() const {return mJumpGravityCapCatch;}
int PlayerConst::getRunTimeContinuousThrow() const {return mRunTimeContinuousThrow;}
float PlayerConst::getRunSpeedMaxContinuousThrow() const {return mRunSpeedMaxContinuousThrow;}
int PlayerConst::getRunAccelFrameContinuousThrow() const {return mRunAccelFrameContinuousThrow;}
float PlayerConst::getSeparateCheckHeight() const {return mSeparateCheckHeight;}
float PlayerConst::getSeparateOffsetLerpRate() const {return mSeparateOffsetLerpRate;}
float PlayerConst::getSeparateEnableThrowHeight() const {return mSeparateEnableThrowHeight;}
float PlayerConst::getTall() const {return mTall;}
float PlayerConst::getCollisionRadius() const {return mCollisionRadius;}
float PlayerConst::getCollisionRadiusSquat() const {return mCollisionRadiusSquat;}
float PlayerConst::getCollisionRadiusStand() const {return mCollisionRadiusStand;}
float PlayerConst::getCollisionSmallStepHeight() const {return mCollisionSmallStepHeight;}
float PlayerConst::getCollisionResetLimit() const {return mCollisionResetLimit;}
float PlayerConst::getReflectCeilingPower() const {return mReflectCeilingPower;}
float PlayerConst::getReflectTossPower() const {return mReflectTossPower;}
float PlayerConst::getReflectUpperPunchScaleH() const {return mReflectUpperPunchScaleH;}
float PlayerConst::getCollisionHitDownAngleH() const {return mCollisionHitDownAngleH;}
float PlayerConst::getCollisionHitDownEscapeAngleV() const {return mCollisionHitDownEscapeAngleV;}
float PlayerConst::getShadowDropHeightScale() const {return mShadowDropHeightScale;}
float PlayerConst::getShadowDropNormalAdd() const {return mShadowDropNormalAdd;}
float PlayerConst::getShadowDropLengthMin() const {return mShadowDropLengthMin;}
float PlayerConst::getShadowDropLengthMax() const {return mShadowDropLengthMax;}
float PlayerConst::getShadowDropLengthExtend() const {return mShadowDropLengthExtend;}
float PlayerConst::getGravityDamage() const {return mGravityDamage;}
float PlayerConst::getHopPowerDamage() const {return mHopPowerDamage;}
float PlayerConst::getPushPowerDamage() const {return mPushPowerDamage;}
int PlayerConst::getDamageCancelFrame() const {return mDamageCancelFrame;}
int PlayerConst::getDamageInvalidCount() const {return mDamageInvalidCount;}
int PlayerConst::getDamageInvalidCountRecovery() const {return mDamageInvalidCountRecovery;}
int PlayerConst::getDamageInvalidCountAbyss() const {return mDamageInvalidCountAbyss;}
float PlayerConst::getNormalMinSpeed2D() const {return mNormalMinSpeed2D;}
float PlayerConst::getNormalMaxSpeed2D() const {return mNormalMaxSpeed2D;}
float PlayerConst::getDashMaxSpeed2D() const {return mDashMaxSpeed2D;}
int PlayerConst::getNormalAccelFrame2D() const {return mNormalAccelFrame2D;}
int PlayerConst::getDashAccelFrame2D() const {return mDashAccelFrame2D;}
int PlayerConst::getNormalDashAnimFrame2D() const {return mNormalDashAnimFrame2D;}
int PlayerConst::getNormalBrakeFrame2D() const {return mNormalBrakeFrame2D;}
int PlayerConst::getStickOnBrakeFrame2D() const {return mStickOnBrakeFrame2D;}
int PlayerConst::getBrakeTurnStartFrame2D() const {return mBrakeTurnStartFrame2D;}
float PlayerConst::getTurnEndSpeedRate2D() const {return mTurnEndSpeedRate2D;}
float PlayerConst::getJumpPowerMin2DArea() const {return mJumpPowerMin2DArea;}
float PlayerConst::getJumpPowerMax2DArea() const {return mJumpPowerMax2DArea;}
float PlayerConst::getJumpPowerMinBorder2D() const {return mJumpPowerMinBorder2D;}
float PlayerConst::getJumpPowerMaxBorder2D() const {return mJumpPowerMaxBorder2D;}
float PlayerConst::getGravityMove() const {return mGravityMove;}
float PlayerConst::getNormalMaxSpeed() const {return mNormalMaxSpeed;}
float PlayerConst::getNormalMinSpeed() const {return mNormalMinSpeed;}
int PlayerConst::getNormalAccelFrame() const {return mNormalAccelFrame;}
float PlayerConst::getRunAccelAverageScale() const {return mRunAccelAverageScale;}
int PlayerConst::getNormalBrakeFrame() const {return mNormalBrakeFrame;}
float PlayerConst::getDashJudgeSpeed() const {return mDashJudgeSpeed;}
int PlayerConst::getStickOnBrakeFrame() const {return mStickOnBrakeFrame;}
int PlayerConst::getNormalDashAnimFrame() const {return mNormalDashAnimFrame;}
float PlayerConst::getRunAfterTurnSpeedMax() const {return mRunAfterTurnSpeedMax;}
float PlayerConst::getRunAfterTurnScale() const {return mRunAfterTurnScale;}
int PlayerConst::getRunAfterTurnFrame() const {return mRunAfterTurnFrame;}
int PlayerConst::getBrakeTurnStartFrame() const {return mBrakeTurnStartFrame;}
float PlayerConst::getBrakeOnSpeedRate() const {return mBrakeOnSpeedRate;}
int PlayerConst::getBrakeOnCounterBorder() const {return mBrakeOnCounterBorder;}
int PlayerConst::getWallPushFrame() const {return mWallPushFrame;}
int PlayerConst::getRunDeepDownFrame() const {return mRunDeepDownFrame;}
int PlayerConst::getRunDeepDownMargine() const {return mRunDeepDownMargine;}
int PlayerConst::getQuickTurnJumpFrame() const {return mQuickTurnJumpFrame;}
int PlayerConst::getRoundAccelFrame() const {return mRoundAccelFrame;}
int PlayerConst::getRoundBrakeFrame() const {return mRoundBrakeFrame;}
float PlayerConst::getRoundFastDegree() const {return mRoundFastDegree;}
int PlayerConst::getRoundAccelFrameFast() const {return mRoundAccelFrameFast;}
float PlayerConst::getRoundMinDegree() const {return mRoundMinDegree;}
int PlayerConst::getRoundBrakeFrameForce() const {return mRoundBrakeFrameForce;}
float PlayerConst::getRoundFastDegreeForce() const {return mRoundFastDegreeForce;}
float PlayerConst::getRoundLimitDegreeForce() const {return mRoundLimitDegreeForce;}
float PlayerConst::getRoundLimitDegreeForceFast() const {return mRoundLimitDegreeForceFast;}
int PlayerConst::getRoundAccelFrameForceFast() const {return mRoundAccelFrameForceFast;}
float PlayerConst::getRoundLimitDegreeMin() const {return mRoundLimitDegreeMin;}
float PlayerConst::getRoundLimitDegree() const {return mRoundLimitDegree;}
int PlayerConst::getIceAccelFrame() const {return mIceAccelFrame;}
int PlayerConst::getIceBrakeFrame() const {return mIceBrakeFrame;}
int PlayerConst::getIceBrakeFrameHigh() const {return mIceBrakeFrameHigh;}
int PlayerConst::getIceBrakeFrameWall() const {return mIceBrakeFrameWall;}
int PlayerConst::getIceRoundAccelFrame() const {return mIceRoundAccelFrame;}
int PlayerConst::getIceRoundAccelFrameFast() const {return mIceRoundAccelFrameFast;}
int PlayerConst::getIceRoundBrakeFrame() const {return mIceRoundBrakeFrame;}
float PlayerConst::getIceRoundFastDegree() const {return mIceRoundFastDegree;}
float PlayerConst::getIceRoundMinDegree() const {return mIceRoundMinDegree;}
float PlayerConst::getIceRoundLimitDegree() const {return mIceRoundLimitDegree;}
float PlayerConst::getHillAddSpeed() const {return mHillAddSpeed;}
float PlayerConst::getHillSubSpeed() const {return mHillSubSpeed;}
int PlayerConst::getHillAccelAddFrame() const {return mHillAccelAddFrame;}
int PlayerConst::getHillAccelSubFrame() const {return mHillAccelSubFrame;}
float PlayerConst::getHillAccelSubAngleMin() const {return mHillAccelSubAngleMin;}
float PlayerConst::getHillAccelSubAngleMax() const {return mHillAccelSubAngleMax;}
float PlayerConst::getStandAngleMin() const {return mStandAngleMin;}
float PlayerConst::getStandAngleMax() const {return mStandAngleMax;}
float PlayerConst::getHillAngleSpeedMin() const {return mHillAngleSpeedMin;}
float PlayerConst::getHillAngleSpeedMax() const {return mHillAngleSpeedMax;}
int PlayerConst::getSpinCapThrowFrame() const {return mSpinCapThrowFrame;}
int PlayerConst::getSpinCapThrowFrameAir() const {return mSpinCapThrowFrameAir;}
int PlayerConst::getSpinCapThrowFrameSwim() const {return mSpinCapThrowFrameSwim;}
int PlayerConst::getSpinCapThrowFrameSwing() const {return mSpinCapThrowFrameSwing;}
int PlayerConst::getSpinCapThrowFrameContinuous() const {return mSpinCapThrowFrameContinuous;}
int PlayerConst::getSpinAttackFrame() const {return mSpinAttackFrame;}
int PlayerConst::getSpinBrakeFrame() const {return mSpinBrakeFrame;}
float PlayerConst::getSpinAirJumpPower() const {return mSpinAirJumpPower;}
float PlayerConst::getSpinAirSpeedMax() const {return mSpinAirSpeedMax;}
float PlayerConst::getGravitySpinAir() const {return mGravitySpinAir;}
float PlayerConst::getSlerpQuatRateSpinAir() const {return mSlerpQuatRateSpinAir;}
float PlayerConst::getSpinBrakeRate() const {return mSpinBrakeRate;}
float PlayerConst::getSpinBrakeSideAccel() const {return mSpinBrakeSideAccel;}
float PlayerConst::getSpinBrakeSideBrakeRate() const {return mSpinBrakeSideBrakeRate;}
float PlayerConst::getSpinBrakeSideMaxSpeedRate() const {return mSpinBrakeSideMaxSpeedRate;}
float PlayerConst::getSpinRoundLimitDegree() const {return mSpinRoundLimitDegree;}
float PlayerConst::getDamageFireJumpPower1st() const {return mDamageFireJumpPower1st;}
float PlayerConst::getDamageFireJumpPower2nd() const {return mDamageFireJumpPower2nd;}
float PlayerConst::getDamageFireJumpMoveSpeed() const {return mDamageFireJumpMoveSpeed;}
float PlayerConst::getDamageFireCeilHitSpeed() const {return mDamageFireCeilHitSpeed;}
float PlayerConst::getDamageFireGravity() const {return mDamageFireGravity;}
int PlayerConst::getDamageFireNoGravityFrame() const {return mDamageFireNoGravityFrame;}
int PlayerConst::getDamageFireRunTime() const {return mDamageFireRunTime;}
float PlayerConst::getDamageFireRunSpeed() const {return mDamageFireRunSpeed;}
float PlayerConst::getDamageFireRunBrakeFrame() const {return mDamageFireRunBrakeFrame;}
int PlayerConst::getSandSinkDeadTime() const {return mSandSinkDeadTime;}
int PlayerConst::getSandSinkBrakeHeightH() const {return mSandSinkBrakeHeightH;}
int PlayerConst::getSandSinkBrakeHeightV() const {return mSandSinkBrakeHeightV;}
float PlayerConst::getSandSinkHeight() const {return mSandSinkHeight;}
float PlayerConst::getSandSinkCapThrow() const {return mSandSinkCapThrow;}
float PlayerConst::getSandSinkBrakeMinH() const {return mSandSinkBrakeMinH;}
float PlayerConst::getSandSinkBrakeMaxH() const {return mSandSinkBrakeMaxH;}
float PlayerConst::getSandSinkBrakeMinV() const {return mSandSinkBrakeMinV;}
float PlayerConst::getSandSinkBrakeMaxV() const {return mSandSinkBrakeMaxV;}
float PlayerConst::getSlopeSlideAngleStart() const {return mSlopeSlideAngleStart;}
float PlayerConst::getSlopeSlideAngleEnd() const {return mSlopeSlideAngleEnd;}
float PlayerConst::getSlopeSlideAccel() const {return mSlopeSlideAccel;}
float PlayerConst::getSlopeSlideBrake() const {return mSlopeSlideBrake;}
float PlayerConst::getSlopeSlideMaxSpeed() const {return mSlopeSlideMaxSpeed;}
float PlayerConst::getSlopeSlideSpeedEnd() const {return mSlopeSlideSpeedEnd;}
float PlayerConst::getSlopeSlideSideAccel() const {return mSlopeSlideSideAccel;}
float PlayerConst::getSlopeSlideSideBrake() const {return mSlopeSlideSideBrake;}
float PlayerConst::getSlopeSlideSideMaxSpeed() const {return mSlopeSlideSideMaxSpeed;}
float PlayerConst::getSlopeTurnDegree() const {return mSlopeTurnDegree;}
int PlayerConst::getSlideInvalidFrame() const {return mSlideInvalidFrame;}
int PlayerConst::getSlopeForceFrame() const {return mSlopeForceFrame;}
float PlayerConst::getSlopeSlideForceSideAccel() const {return mSlopeSlideForceSideAccel;}
float PlayerConst::getSlopeSlideForceSideBrake() const {return mSlopeSlideForceSideBrake;}
float PlayerConst::getSlopeSlideForceSideMaxSpeed() const {return mSlopeSlideForceSideMaxSpeed;}
float PlayerConst::getSlopeSlideForceTurnDegree() const {return mSlopeSlideForceTurnDegree;}
float PlayerConst::getSlopeRollingSpeedStart() const {return mSlopeRollingSpeedStart;}
float PlayerConst::getSlopeRollingSpeedBoost() const {return mSlopeRollingSpeedBoost;}
float PlayerConst::getSlopeRollingMaxSpeed() const {return mSlopeRollingMaxSpeed;}
int PlayerConst::getSlopeRollingFrameMinBoost() const {return mSlopeRollingFrameMinBoost;}
int PlayerConst::getSlopeRollingFrameMin() const {return mSlopeRollingFrameMin;}
float PlayerConst::getSlopeRollingStartJumpPower() const {return mSlopeRollingStartJumpPower;}
float PlayerConst::getSlopeRollingStartSlideSpeed() const {return mSlopeRollingStartSlideSpeed;}
float PlayerConst::getSlopeRollingAccel() const {return mSlopeRollingAccel;}
float PlayerConst::getSlopeRollingBrake() const {return mSlopeRollingBrake;}
float PlayerConst::getSlopeRollingAgainst() const {return mSlopeRollingAgainst;}
float PlayerConst::getSlopeRollingAnglePowerMax() const {return mSlopeRollingAnglePowerMax;}
float PlayerConst::getSlopeRollingSpeedEnd() const {return mSlopeRollingSpeedEnd;}
float PlayerConst::getSlopeRollingSideAccel() const {return mSlopeRollingSideAccel;}
float PlayerConst::getSlopeRollingSideBrake() const {return mSlopeRollingSideBrake;}
float PlayerConst::getSlopeRollingSideMaxSpeed() const {return mSlopeRollingSideMaxSpeed;}
int PlayerConst::getSlopeRollingUnRollFrame() const {return mSlopeRollingUnRollFrame;}
float PlayerConst::getSlopeRollingEndBrake() const {return mSlopeRollingEndBrake;}
float PlayerConst::getSlopeRollingEndBrakeEndSpeed() const {return mSlopeRollingEndBrakeEndSpeed;}
float PlayerConst::getSlopeRollingReStartAccel() const {return mSlopeRollingReStartAccel;}
float PlayerConst::getSlopeRollingReStartMaxAdd() const {return mSlopeRollingReStartMaxAdd;}
int PlayerConst::getSlopeRollingReStartInterval() const {return mSlopeRollingReStartinterval;}
int PlayerConst::getSlopeRollingReStartSwing() const {return mSlopeRollingReStartSwing;}
int PlayerConst::getSlopeRollingReStartCharge() const {return mSlopeRollingReStartCharge;}
int PlayerConst::getSlopeRollingReStartForce() const {return mSlopeRollingReStartForce;}
float PlayerConst::getSlopeRollingAccelOnSkate() const {return mSlopeRollingAccelOnSkate;}
float PlayerConst::getSlopeRollingSideAccelOnSkate() const {return mSlopeRollingSideAccelOnSkate;}
float PlayerConst::getSlopeRollingBrakeOnSkate() const {return mSlopeRollingBrakeOnSkate;}
int PlayerConst::getExtendFrame() const {return mExtendFrame;}
float PlayerConst::getJumpInertiaRate() const {return mJumpInertiaRate;}
float PlayerConst::getJumpPowerMin() const {return mJumpPowerMin;}
float PlayerConst::getJumpPowerMax() const {return mJumpPowerMax;}
float PlayerConst::getJumpGravity() const {return mJumpGravity;}
float PlayerConst::getJumpBaseSpeedMax() const {return mJumpBaseSpeedMax;}
float PlayerConst::getJumpMoveSpeedMin() const {return mJumpMoveSpeedMin;}
float PlayerConst::getJumpMoveSpeedMax() const {return mJumpMoveSpeedMax;}
float PlayerConst::getJumpAccelFront() const {return mJumpAccelFront;}
float PlayerConst::getJumpAccelBack() const {return mJumpAccelBack;}
float PlayerConst::getJumpAccelTurn() const {return mJumpAccelTurn;}
float PlayerConst::getJumpTurnAngleStart() const {return mJumpTurnAngleStart;}
float PlayerConst::getJumpTurnAngleLimit() const {return mJumpTurnAngleLimit;}
float PlayerConst::getJumpTurnAngleFast() const {return mJumpTurnAngleFast;}
float PlayerConst::getJumpTurnAngleFastLimit() const {return mJumpTurnAngleFastLimit;}
int PlayerConst::getJumpTurnAccelFrame() const {return mJumpTurnAccelFrame;}
int PlayerConst::getJumpTurnAccelFrameFast() const {return mJumpTurnAccelFrameFast;}
int PlayerConst::getJumpTurnBrakeFrame() const {return mJumpTurnBrakeFrame;}
float PlayerConst::getTrampleGravity() const {return mTrampleGravity;}
float PlayerConst::getTrampleJumpPower() const {return mTrampleJumpPower;}
float PlayerConst::getTrampleHighGravity() const {return mTrampleHighGravity;}
float PlayerConst::getTrampleHighJumpPower() const {return mTrampleHighJumpPower;}
float PlayerConst::getTrampleGravity2D() const {return mTrampleGravity2D;}
float PlayerConst::getTrampleJumpPower2D() const {return mTrampleJumpPower2D;}
float PlayerConst::getTrampleHighGravity2D() const {return mTrampleHighGravity2D;}
float PlayerConst::getTrampleHighJumpPower2D() const {return mTrampleHighJumpPower2D;}
float PlayerConst::getTrampleHipDropGravity() const {return mTrampleHipDropGravity;}
float PlayerConst::getTrampleHipDropJumpPower() const {return mTrampleHipDropJumpPower;}
float PlayerConst::getTrampleRisingBrakeVelH() const {return mTrampleRisingBrakeVelH;}
float PlayerConst::getTrampleJumpCodePower() const {return mTrampleJumpCodePower;}
float PlayerConst::getTrampleJumpCodePowerSmall() const {return mTrampleJumpCodePowerSmall;}
float PlayerConst::getCapLeapFrogJumpGravity() const {return mCapLeapFrogJumpGravity;}
float PlayerConst::getCapLeapFrogJumpPower() const {return mCapLeapFrogJumpPower;}
float PlayerConst::getCapLeapFrogJumpPowerAir() const {return mCapLeapFrogJumpPowerAir;}
float PlayerConst::getObjLeapFrogJumpPower() const {return mObjLeapFrogJumpPower;}
float PlayerConst::getObjLeapFrogJumpPowerHigh() const {return mObjLeapFrogJumpPowerHigh;}
float PlayerConst::getCapHeadSpringJumpGravity() const {return mCapHeadSpringJumpGravity;}
float PlayerConst::getCapHeadSpringJumpPower() const {return mCapHeadSpringJumpPower;}
float PlayerConst::getCapHeadSpringJumpGravityHigh() const {return mCapHeadSpringJumpGravityHigh;}
float PlayerConst::getCapHeadSpringJumpPowerHigh() const {return mCapHeadSpringJumpPowerHigh;}
float PlayerConst::getCapHeadSpringSpeedMax() const {return mCapHeadSpringSpeedMax;}
int PlayerConst::getContinuousJumpPreInputFrame() const {return mContinuousJumpPreInputFrame;}
int PlayerConst::getContinuousJumpCount() const {return mContinuousJumpCount;}
int PlayerConst::getContinuousJumpTimer() const {return mContinuousJumpTimer;}
float PlayerConst::getContinuousJumpPowerMin() const {return mContinuousJumpPowerMin;}
float PlayerConst::getJumpPowerMax2nd() const {return mJumpPowerMax2nd;}
float PlayerConst::getJumpGravity2nd() const {return mJumpGravity2nd;}
float PlayerConst::getJumpPowerMax3rd() const {return mJumpPowerMax3rd;}
float PlayerConst::getJumpGravity3rd() const {return mJumpGravity3rd;}
float PlayerConst::getSpinFlowerJumpGravity() const {return mSpinFlowerJumpGravity;}
float PlayerConst::getSpinFlowerJumpFallSpeedMax() const {return mSpinFlowerJumpFallSpeedMax;}
float PlayerConst::getSpinFlowerJumpMovePower() const {return mSpinFlowerJumpMovePower;}
float PlayerConst::getSpinFlowerJumpVelMax() const {return mSpinFlowerJumpVelMax;}
int PlayerConst::getSpinFlowerJumpStayFrame() const {return mSpinFlowerJumpStayFrame;}
float PlayerConst::getSpinFlowerJumpStaySpeedMax() const {return mSpinFlowerJumpStaySpeedMax;}
float PlayerConst::getSpinFlowerJumpNoInputBrake() const {return mSpinFlowerJumpNoInputBrake;}
float PlayerConst::getSpinFlowerJumpDownFallInitSpeed() const {return mSpinFlowerJumpDownFallInitSpeed;}
float PlayerConst::getSpinFlowerJumpDownFallPower() const {return mSpinFlowerJumpDownFallPower;}
float PlayerConst::getSpinFlowerJumpDownFallSpeedMax() const {return mSpinFlowerJumpDownFallSpeedMax;}
float PlayerConst::getJumpGravityForceRun() const {return mJumpGravityForceRun;}
float PlayerConst::getJumpPowerForceRun() const {return mJumpPowerForceRun;}
float PlayerConst::getCapCatchPopPower() const {return mCapCatchPopPower;}
float PlayerConst::getCapCatchPopGravity() const {return mCapCatchPopGravity;}
float PlayerConst::getSquatJumpGravity() const {return mSquatJumpGravity;}
float PlayerConst::getSquatJumpPower() const {return mSquatJumpPower;}
float PlayerConst::getSquatJumpBackPower() const {return mSquatJumpBackPower;}
float PlayerConst::getSquatJumpMovePowerFront() const {return mSquatJumpMovePowerFront;}
float PlayerConst::getSquatJumpMovePowerSide() const {return mSquatJumpMovePowerSide;}
float PlayerConst::getSquatJumpMoveSpeedMax() const {return mSquatJumpMoveSpeedMax;}
float PlayerConst::getTurnJumpGravity() const {return mTurnJumpGravity;}
float PlayerConst::getTurnJumpPower() const {return mTurnJumpPower;}
float PlayerConst::getTurnJumpVelH() const {return mTurnJumpVelH;}
float PlayerConst::getTurnJumpBrake() const {return mTurnJumpBrake;}
float PlayerConst::getTurnJumpAccel() const {return mTurnJumpAccel;}
float PlayerConst::getTurnJumpSideAccel() const {return mTurnJumpSideAccel;}
float PlayerConst::getLongJumpAccel() const {return mLongJumpAccel;}
float PlayerConst::getLongJumpBrake() const {return mLongJumpBrake;}
float PlayerConst::getLongJumpSideAccel() const {return mLongJumpSideAccel;}
float PlayerConst::getLongJumpGravity() const {return mLongJumpGravity;}
float PlayerConst::getLongJumpJumpPow() const {return mLongJumpJumpPow;}
float PlayerConst::getLongJumpMovePow() const {return mLongJumpMovePow;}
float PlayerConst::getLongJumpInitSpeed() const {return mLongJumpInitSpeed;}
float PlayerConst::getLongJumpSpeed() const {return mLongJumpSpeed;}
float PlayerConst::getLongJumpSpeedMin() const {return mLongJumpSpeedMin;}
int PlayerConst::getContinuousLongJumpCount() const {return mContinuousLongJumpCount;}
int PlayerConst::getContinuousLongJumpTimer() const {return mContinuousLongJumpTimer;}
float PlayerConst::getGravityAir() const {return mGravityAir;}
float PlayerConst::getFrictionAir() const {return mFrictionAir;}
float PlayerConst::getFallSpeedMax() const {return mFallSpeedMax;}
float PlayerConst::getLongFallDistance() const {return mLongFallDistance;}
float PlayerConst::getFallWallScaleVelocity() const {return mFallWallScaleVelocity;}
int PlayerConst::getDownFallFrameMin() const {return mDownFallFrameMin;}
float PlayerConst::getGravityWallSlide() const {return mGravityWallSlide;}
float PlayerConst::getWallHeightLowLimit() const {return mWallHeightLowLimit;}
float PlayerConst::getWallKeepDegree() const {return mWallKeepDegree;}
int PlayerConst::getWallKeepFrame() const {return mWallKeepFrame;}
float PlayerConst::getWallJumpGravity() const {return mWallJumpGravity;}
float PlayerConst::getWallJumpHSpeed() const {return mWallJumpHSpeed;}
float PlayerConst::getWallJumpPower() const {return mWallJumpPower;}
int PlayerConst::getWallJumpInvalidateInputFrame() const {return mWallJumpInvalidateInputFrame;}
int PlayerConst::getWallInhibitAfterPunch() const {return mWallInhibitAfterPunch;}
float PlayerConst::getWallFollowAngleH() const {return mWallFollowAngleH;}
float PlayerConst::getWallFollowAngleV() const {return mWallFollowAngleV;}
float PlayerConst::getWallCatchDegree() const {return mWallCatchDegree;}
float PlayerConst::getWallCatchHeightEdgeTop() const {return mWallCatchHeightEdgeTop;}
float PlayerConst::getWallCatchHeightBottom() const {return mWallCatchHeightBottom;}
float PlayerConst::getWallCatchKeepDegree() const {return mWallCatchKeepDegree;}
float PlayerConst::getWallCatchMoveDegree() const {return mWallCatchMoveDegree;}
float PlayerConst::getWallCatchMoveSpeed() const {return mWallCatchMoveSpeed;}
float PlayerConst::getWallCatchMoveHeightRange() const {return mWallCatchMoveHeightRange;}
int PlayerConst::getWallCatchMoveInterpolate() const {return mWallCatchMoveinterpolate;}
int PlayerConst::getWallCatchMoveFrame() const {return mWallCatchMoveFrame;}
int PlayerConst::getWallCatchMoveFrameFast() const {return mWallCatchMoveFrameFast;}
int PlayerConst::getWallCatchMoveFrameSwing() const {return mWallCatchMoveFrameSwing;}
float PlayerConst::getWallCatchInputRepeatAngle() const {return mWallCatchInputRepeatAngle;}
float PlayerConst::getWallClimbDegree() const {return mWallClimbDegree;}
int PlayerConst::getWallClimbJumpStartFrame() const {return mWallClimbJumpStartFrame;}
int PlayerConst::getWallClimbJumpEndFrame() const {return mWallClimbJumpEndFrame;}
int PlayerConst::getWallClimbStartFrame() const {return mWallClimbStartFrame;}
float PlayerConst::getWallClimbGravity() const {return mWallClimbGravity;}
float PlayerConst::getWallFallJumpSpeed() const {return mWallFallJumpSpeed;}
float PlayerConst::getWallClimbJumpSpeedV() const {return mWallClimbJumpSpeedV;}
float PlayerConst::getWallClimbJumpSpeedH() const {return mWallClimbJumpSpeedH;}
float PlayerConst::getWallClimbJumpGravity() const {return mWallClimbJumpGravity;}
int PlayerConst::getWallClimbJumpInvalidFrame() const {return mWallClimbJumpInvalidFrame;}
float PlayerConst::getWallCatchHipLocalOffset() const {return mWallCatchHipLocalOffset;}
float PlayerConst::getWallCatchHipStability() const {return mWallCatchHipStability;}
float PlayerConst::getWallCatchHipFriction() const {return mWallCatchHipFriction;}
float PlayerConst::getWallCatchHipLimitDegree() const {return mWallCatchHipLimitDegree;}
float PlayerConst::getWallCatchStainAreaOffset() const {return mWallCatchStainAreaOffset;}
float PlayerConst::getGrabCeilRange() const {return mGrabCeilRange;}
float PlayerConst::getGrabCeilBodyRadius() const {return mGrabCeilBodyRadius;}
float PlayerConst::getGrabCeilLeaveSpeedMin() const {return mGrabCeilLeaveSpeedMin;}
float PlayerConst::getGrabCeilLeavePopPower() const {return mGrabCeilLeavePopPower;}
float PlayerConst::getGrabCeilLeavePopGravity() const {return mGrabCeilLeavePopGravity;}
float PlayerConst::getGrabCeilSwingStartOffset() const {return mGrabCeilSwingStartOffset;}
float PlayerConst::getGrabCeilReverseInputBorder() const {return mGrabCeilReverseInputBorder;}
float PlayerConst::getGrabCeilInputPowerBorder() const {return mGrabCeilInputPowerBorder;}
float PlayerConst::getGrabCeilSwingWaitEnergy() const {return mGrabCeilSwingWaitEnergy;}
float PlayerConst::getGrabCeilEnableJumpEnergy() const {return mGrabCeilEnableJumpEnergy;}
float PlayerConst::getGrabCeilEnableJumpEnergyMax() const {return mGrabCeilEnableJumpEnergyMax;}
float PlayerConst::getGrabCeilJumpForceAngle() const {return mGrabCeilJumpForceAngle;}
float PlayerConst::getGrabCeilJumpPower() const {return mGrabCeilJumpPower;}
float PlayerConst::getGrabCeilJumpMoveMin() const {return mGrabCeilJumpMoveMin;}
float PlayerConst::getGrabCeilJumpMoveMax() const {return mGrabCeilJumpMoveMax;}
float PlayerConst::getGrabCeilJumpGravity() const {return mGrabCeilJumpGravity;}
int PlayerConst::getGrabCeilJumpInvalidFrame() const {return mGrabCeilJumpInvalidFrame;}
int PlayerConst::getGrabCeilEnableNextFrame() const {return mGrabCeilEnableNextFrame;}
int PlayerConst::getGrabCeilEnableFallSnapFrame() const {return mGrabCeilEnableFallSnapFrame;}
int PlayerConst::getPoleClimbPreInputSwing() const {return mPoleClimbPreInputSwing;}
float PlayerConst::getPoleClimbInputRepeatAngle() const {return mPoleClimbInputRepeatAngle;}
float PlayerConst::getPoleClimbInputDegreeMove() const {return mPoleClimbInputDegreeMove;}
float PlayerConst::getPoleClimbCatchRange() const {return mPoleClimbCatchRange;}
float PlayerConst::getPoleClimbCatchRangeMin() const {return mPoleClimbCatchRangeMin;}
float PlayerConst::getPoleClimbCatchRangeMax() const {return mPoleClimbCatchRangeMax;}
float PlayerConst::getPoleClimbJointAngleMin() const {return mPoleClimbJointAngleMin;}
float PlayerConst::getPoleClimbJointAngleMax() const {return mPoleClimbJointAngleMax;}
float PlayerConst::getPoleClimbJointRangeMin() const {return mPoleClimbJointRangeMin;}
float PlayerConst::getPoleClimbJointRangeMax() const {return mPoleClimbJointRangeMax;}
float PlayerConst::getPoleClimbMoveWallDegree() const {return mPoleClimbMoveWallDegree;}
float PlayerConst::getPoleClimbUpMargine() const {return mPoleClimbUpMargine;}
float PlayerConst::getPoleClimbUpSpeed() const {return mPoleClimbUpSpeed;}
int PlayerConst::getPoleClimbUpFrame() const {return mPoleClimbUpFrame;}
int PlayerConst::getPoleClimbUpFrameFast() const {return mPoleClimbUpFrameFast;}
int PlayerConst::getPoleClimbUpFrameSwing() const {return mPoleClimbUpFrameSwing;}
float PlayerConst::getPoleClimbDownSpeed() const {return mPoleClimbDownSpeed;}
float PlayerConst::getPoleClimbDownSpeedFast() const {return mPoleClimbDownSpeedFast;}
float PlayerConst::getPoleClimbDownSpeedSwing() const {return mPoleClimbDownSpeedSwing;}
int PlayerConst::getPoleClimbDownFrame() const {return mPoleClimbDownFrame;}
int PlayerConst::getPoleClimbDownKeepTime() const {return mPoleClimbDownKeepTime;}
float PlayerConst::getPoleClimbTurnDist() const {return mPoleClimbTurnDist;}
int PlayerConst::getPoleClimbTurnFrame() const {return mPoleClimbTurnFrame;}
int PlayerConst::getPoleClimbTurnStopFrame() const {return mPoleClimbTurnStopFrame;}
int PlayerConst::getPoleTopStartFrame() const {return mPoleTopStartFrame;}
int PlayerConst::getPoleTopEndFrame() const {return mPoleTopEndFrame;}
float PlayerConst::getPoleTopTurnSpeed() const {return mPoleTopTurnSpeed;}
float PlayerConst::getPoleTopEndUnderOffsetY() const {return mPoleTopEndUnderOffsetY;}
int PlayerConst::getGroundSpinFrame() const {return mGroundSpinFrame;}
float PlayerConst::getGroundSpinMoveSpeedMax() const {return mGroundSpinMoveSpeedMax;}
float PlayerConst::getGroundSpinAccelRate() const {return mGroundSpinAccelRate;}
float PlayerConst::getGroundSpinBrakeRate() const {return mGroundSpinBrakeRate;}
float PlayerConst::getSpinJumpGravity() const {return mSpinJumpGravity;}
float PlayerConst::getSpinJumpPower() const {return mSpinJumpPower;}
float PlayerConst::getSpinJumpMoveSpeedMax() const {return mSpinJumpMoveSpeedMax;}
float PlayerConst::getSpinJumpDownFallInitSpeed() const {return mSpinJumpDownFallInitSpeed;}
float PlayerConst::getSpinJumpDownFallPower() const {return mSpinJumpDownFallPower;}
float PlayerConst::getSpinJumpDownFallSpeedMax() const {return mSpinJumpDownFallSpeedMax;}
float PlayerConst::getSquatBrakeEndSpeed() const {return mSquatBrakeEndSpeed;}
float PlayerConst::getSquatAccelRate() const {return mSquatAccelRate;}
float PlayerConst::getSquatBrakeRate() const {return mSquatBrakeRate;}
float PlayerConst::getSquatBrakeRateOnSkate() const {return mSquatBrakeRateOnSkate;}
float PlayerConst::getSquatBrakeSideAccel() const {return mSquatBrakeSideAccel;}
float PlayerConst::getSquatBrakeSideRate() const {return mSquatBrakeSideRate;}
float PlayerConst::getSquatBrakeSideAccelOnSkate() const {return mSquatBrakeSideAccelOnSkate;}
float PlayerConst::getSquatBrakeSideRateOnSkate() const {return mSquatBrakeSideRateOnSkate;}
float PlayerConst::getSquatBrakeSideMaxSpeedRate() const {return mSquatBrakeSideMaxSpeedRate;}
float PlayerConst::getSquatWalkSpeed() const {return mSquatWalkSpeed;}
float PlayerConst::getSquatWalkTurnSpeed() const {return mSquatWalkTurnSpeed;}
int PlayerConst::getSquatWalkTurnFrame() const {return mSquatWalkTurnFrame;}
float PlayerConst::getSquatJumpCeilSlideSpeed2D() const {return mSquatJumpCeilSlideSpeed2D;}
float PlayerConst::getHipDropSpeed() const {return mHipDropSpeed;}
float PlayerConst::getHipDropGravity() const {return mHipDropGravity;}
float PlayerConst::getHipDropSpeedMax() const {return mHipDropSpeedMax;}
int PlayerConst::getHipDropLandCancelFrame() const {return mHipDropLandCancelFrame;}
float PlayerConst::getHipDropHeight() const {return mHipDropHeight;}
int PlayerConst::getHipDropMsgInterval() const {return mHipDropMsginterval;}
float PlayerConst::getJumpHipDropPower() const {return mJumpHipDropPower;}
int PlayerConst::getJumpHipDropPermitBeginFrame() const {return mJumpHipDropPermitBeginFrame;}
int PlayerConst::getJumpHipDropPermitEndFrame() const {return mJumpHipDropPermitEndFrame;}
float PlayerConst::getHeadSlidingSpeed() const {return mHeadSlidingSpeed;}
float PlayerConst::getHeadSlidingSpeedMin() const {return mHeadSlidingSpeedMin;}
float PlayerConst::getHeadSlidingBrake() const {return mHeadSlidingBrake;}
float PlayerConst::getHeadSlidingSideAccel() const {return mHeadSlidingSideAccel;}
float PlayerConst::getHeadSlidingJump() const {return mHeadSlidingJump;}
float PlayerConst::getHeadSlidingGravityAir() const {return mHeadSlidingGravityAir;}
float PlayerConst::getSwimCenterOffset() const {return mSwimCenterOffset;}
float PlayerConst::getSwimWallCatchOffset() const {return mSwimWallCatchOffset;}
float PlayerConst::getSwimRisePower() const {return mSwimRisePower;}
float PlayerConst::getSwimRiseSpeedMax() const {return mSwimRiseSpeedMax;}
int PlayerConst::getSwimRiseFrame() const {return mSwimRiseFrame;}
float PlayerConst::getSwimGravity() const {return mSwimGravity;}
float PlayerConst::getSwimGravityWalk() const {return mSwimGravityWalk;}
float PlayerConst::getSwimFallSpeedMax() const {return mSwimFallSpeedMax;}
float PlayerConst::getSwimFloorAccelH() const {return mSwimFloorAccelH;}
float PlayerConst::getSwimFloorSpeedMaxH() const {return mSwimFloorSpeedMaxH;}
float PlayerConst::getSwimHighAccelH() const {return mSwimHighAccelH;}
float PlayerConst::getSwimHighSpeedMaxH() const {return mSwimHighSpeedMaxH;}
float PlayerConst::getSwimLowAccelH() const {return mSwimLowAccelH;}
float PlayerConst::getSwimLowSpeedMaxH() const {return mSwimLowSpeedMaxH;}
float PlayerConst::getSwimBrakeRateH() const {return mSwimBrakeRateH;}
float PlayerConst::getSwimWallHitSpeedMinH() const {return mSwimWallHitSpeedMinH;}
int PlayerConst::getSwimHighAccelPermitFrame() const {return mSwimHighAccelPermitFrame;}
float PlayerConst::getSwimFlowFieldBlend() const {return mSwimFlowFieldBlend;}
float PlayerConst::getSwimWalkAnimMinRate() const {return mSwimWalkAnimMinRate;}
float PlayerConst::getSwimWalkAnimMaxRate() const {return mSwimWalkAnimMaxRate;}
float PlayerConst::getSwimWalkMaxSpeed() const {return mSwimWalkMaxSpeed;}
float PlayerConst::getSwimSpinCapUpPower() const {return mSwimSpinCapUpPower;}
float PlayerConst::getSwimSpinCapUpSpeedMax() const {return mSwimSpinCapUpSpeedMax;}
float PlayerConst::getSwimRotStartAngle() const {return mSwimRotStartAngle;}
float PlayerConst::getSwimRotFastAngle() const {return mSwimRotFastAngle;}
int PlayerConst::getSwimRotAccelFrame() const {return mSwimRotAccelFrame;}
int PlayerConst::getSwimRotAccelFrameFast() const {return mSwimRotAccelFrameFast;}
int PlayerConst::getSwimRotBrakeFrame() const {return mSwimRotBrakeFrame;}
float PlayerConst::getSwimRotSpeedChangeStart() const {return mSwimRotSpeedChangeStart;}
float PlayerConst::getSwimRotSpeedForward() const {return mSwimRotSpeedForward;}
float PlayerConst::getSwimRotSpeedMax() const {return mSwimRotSpeedMax;}
float PlayerConst::getSwimSurfaceAccelH() const {return mSwimSurfaceAccelH;}
float PlayerConst::getSwimSurfaceSpeedMaxH() const {return mSwimSurfaceSpeedMaxH;}
int PlayerConst::getSwimSurfaceSpinCapFrame() const {return mSwimSurfaceSpinCapFrame;}
float PlayerConst::getSwimSurfaceSpinCapSpeedMaxH() const {return mSwimSurfaceSpinCapSpeedMaxH;}
float PlayerConst::getSwimSurfaceStartDist() const {return mSwimSurfaceStartDist;}
float PlayerConst::getSwimSurfaceEndDist() const {return mSwimSurfaceEndDist;}
float PlayerConst::getSwimSurfaceGravity() const {return mSwimSurfaceGravity;}
float PlayerConst::getSwimSurfaceBaseHeight() const {return mSwimSurfaceBaseHeight;}
float PlayerConst::getSwimSurfaceSpring() const {return mSwimSurfaceSpring;}
float PlayerConst::getSwimSurfaceDamper() const {return mSwimSurfaceDamper;}
int PlayerConst::getSwimSurfaceDamperStart() const {return mSwimSurfaceDamperStart;}
int PlayerConst::getSwimSurfaceDamperFrame() const {return mSwimSurfaceDamperFrame;}
float PlayerConst::getSwimSurfaceEnableJumpHeight() const {return mSwimSurfaceEnableJumpHeight;}
int PlayerConst::getSwimSurfacePreInputJumpFrame() const {return mSwimSurfacePreInputJumpFrame;}
float PlayerConst::getSwimSurfaceMoveSpring() const {return mSwimSurfaceMoveSpring;}
float PlayerConst::getSwimSurfaceMoveDamper() const {return mSwimSurfaceMoveDamper;}
float PlayerConst::getSwimSurfaceMoveBaseHeight() const {return mSwimSurfaceMoveBaseHeight;}
float PlayerConst::getSwimRunSurfaceBaseHeight() const {return mSwimRunSurfaceBaseHeight;}
float PlayerConst::getSwimRunSurfaceApproachRate() const {return mSwimRunSurfaceApproachRate;}
float PlayerConst::getSwimRunSurfaceApproachLimit() const {return mSwimRunSurfaceApproachLimit;}
float PlayerConst::getSwimRunSurfaceBrakeBorder() const {return mSwimRunSurfaceBrakeBorder;}
float PlayerConst::getSwimRunSurfaceBrakeH() const {return mSwimRunSurfaceBrakeH;}
float PlayerConst::getSwimRunSurfaceApproachBorderMax() const {return mSwimRunSurfaceApproachBorderMax;}
float PlayerConst::getSwimRunSurfaceApproachBorderMin() const {return mSwimRunSurfaceApproachBorderMin;}
float PlayerConst::getSwimRunSurfaceApproachRateMin() const {return mSwimRunSurfaceApproachRateMin;}
float PlayerConst::getSwimFallInSpeed() const {return mSwimFallInSpeed;}
float PlayerConst::getSwimFallInBrakeH() const {return mSwimFallInBrakeH;}
float PlayerConst::getSwimFallInBrakeV() const {return mSwimFallInBrakeV;}
float PlayerConst::getSwimHeadInBrakeH() const {return mSwimHeadInBrakeH;}
float PlayerConst::getSwimHeadInBrakeV() const {return mSwimHeadInBrakeV;}
float PlayerConst::getSwimHeadInRisePower() const {return mSwimHeadInRisePower;}
float PlayerConst::getSwimHeadInRiseSpeedMax() const {return mSwimHeadInRiseSpeedMax;}
float PlayerConst::getSwimHeadInSurfaceHeight() const {return mSwimHeadInSurfaceHeight;}
int PlayerConst::getSwimFallInForceSurfaceFrame() const {return mSwimFallInForceSurfaceFrame;}
int PlayerConst::getSwimFallInvalidJumpFrame() const {return mSwimFallInvalidJumpFrame;}
float PlayerConst::getSwimDiveStartSpeed() const {return mSwimDiveStartSpeed;}
float PlayerConst::getSwimDiveBrake() const {return mSwimDiveBrake;}
float PlayerConst::getSwimDiveEndSpeed() const {return mSwimDiveEndSpeed;}
int PlayerConst::getSwimDiveLandCount() const {return mSwimDiveLandCount;}
int PlayerConst::getSwimDiveLandCancelFrame() const {return mSwimDiveLandCancelFrame;}
int PlayerConst::getSwimDiveNoBrakeFrame() const {return mSwimDiveNoBrakeFrame;}
int PlayerConst::getSwimDiveButtonValidFrame() const {return mSwimDiveButtonValidFrame;}
int PlayerConst::getSwimDiveEndFrame() const {return mSwimDiveEndFrame;}
float PlayerConst::getSwimDiveInBrakeH() const {return mSwimDiveInBrakeH;}
float PlayerConst::getSwimDiveInBrakeV() const {return mSwimDiveInBrakeV;}
float PlayerConst::getSwimDiveInRisePower() const {return mSwimDiveInRisePower;}
float PlayerConst::getSwimDiveInRiseSpeedMax() const {return mSwimDiveInRiseSpeedMax;}
float PlayerConst::getSwimDiveInSurfaceHeight() const {return mSwimDiveInSurfaceHeight;}
int PlayerConst::getSwimDiveInKeepFrame() const {return mSwimDiveInKeepFrame;}
int PlayerConst::getSwimHeadSlidingFrame() const {return mSwimHeadSlidingFrame;}
int PlayerConst::getSwimHeadSlidingBrakeFrame() const {return mSwimHeadSlidingBrakeFrame;}
float PlayerConst::getSwimHeadSlidingSpeed() const {return mSwimHeadSlidingSpeed;}
float PlayerConst::getSwimHeadSlidingSpeedEnd() const {return mSwimHeadSlidingSpeedEnd;}
float PlayerConst::getSwimHeadSlidingBrake() const {return mSwimHeadSlidingBrake;}
float PlayerConst::getSwimHeadSlidingSideAccel() const {return mSwimHeadSlidingSideAccel;}
float PlayerConst::getSwimHeadSlidingJump() const {return mSwimHeadSlidingJump;}
float PlayerConst::getSwimHeadSlidingGravity() const {return mSwimHeadSlidingGravity;}
int PlayerConst::getSwimHeadSlidingEndBrakeFrame() const {return mSwimHeadSlidingEndBrakeFrame;}
int PlayerConst::getSwimHeadSlidingEndSpeedMin() const {return mSwimHeadSlidingEndSpeedMin;}
float PlayerConst::getSwimJumpHipDropSpeed() const {return mSwimJumpHipDropSpeed;}
float PlayerConst::getSwimJumpHipDropBrakeV() const {return mSwimJumpHipDropBrakeV;}
float PlayerConst::getSwimJumpHipDropBrakeVCeiling() const {return mSwimJumpHipDropBrakeVCeiling;}
float PlayerConst::getSwimJumpHipDropGravity() const {return mSwimJumpHipDropGravity;}
float PlayerConst::getSwimJumpHipDropCancelSpeed() const {return mSwimJumpHipDropCancelSpeed;}
float PlayerConst::getSwimJumpHipDropAccelH() const {return mSwimJumpHipDropAccelH;}
float PlayerConst::getSwimJumpHipDropMoveSpeedH() const {return mSwimJumpHipDropMoveSpeedH;}
float PlayerConst::getSwimJumpHipDropPopSpeed() const {return mSwimJumpHipDropPopSpeed;}
float PlayerConst::getSwimJumpHipDropPopJumpAdd() const {return mSwimJumpHipDropPopJumpAdd;}
float PlayerConst::getSwimTramplePower() const {return mSwimTramplePower;}
float PlayerConst::getDiveTramplePower() const {return mDiveTramplePower;}
int PlayerConst::getDiveTrampleCancelFrame() const {return mDiveTrampleCancelFrame;}
float PlayerConst::getDamageSwimPushPower() const {return mDamageSwimPushPower;}
float PlayerConst::getDamageSwimGravity() const {return mDamageSwimGravity;}
int PlayerConst::getDamageSwimCancelFrame() const {return mDamageSwimCancelFrame;}
float PlayerConst::getDamageSwimSurfaceGravity() const {return mDamageSwimSurfaceGravity;}
float PlayerConst::getDamageSwimSurfaceHopPower() const {return mDamageSwimSurfaceHopPower;}
float PlayerConst::getDamageSwimSurfacePushPower() const {return mDamageSwimSurfacePushPower;}
float PlayerConst::getDamageSwimSurfaceLandSpeed() const {return mDamageSwimSurfaceLandSpeed;}
float PlayerConst::getDamageSwimSurfaceLandBrake() const {return mDamageSwimSurfaceLandBrake;}
float PlayerConst::getDamageSwimSurfaceLandEndSpeed() const {return mDamageSwimSurfaceLandEndSpeed;}
int PlayerConst::getDamageSwimSurfaceCancelFrame() const {return mDamageSwimSurfaceCancelFrame;}
float PlayerConst::getDamageSwimBrakeRateGround() const {return mDamageSwimBrakeRateGround;}
int PlayerConst::getOxygenReduceFrame() const {return mOxygenReduceFrame;}
int PlayerConst::getOxygenNoReduceFrame() const {return mOxygenNoReduceFrame;}
int PlayerConst::getOxygenRecoveryFrame() const {return mOxygenRecoveryFrame;}
int PlayerConst::getOxygenDamageInterval() const {return mOxygenDamageinterval;}
int PlayerConst::getIceWaterDamageInterval() const {return mIceWaterDamageinterval;}
int PlayerConst::getIceWaterRecoveryFrame() const {return mIceWaterRecoveryFrame;}
float PlayerConst::getMoveAnimSpeedMax() const {return mMoveAnimSpeedMax;}
float PlayerConst::getAnimFrameRateSpeedMin() const {return mAnimFrameRateSpeedMin;}
float PlayerConst::getRunBorderSpeed() const {return mRunBorderSpeed;}
float PlayerConst::getRunBlendRange() const {return mRunBlendRange;}
float PlayerConst::getDashBorderSpeed() const {return mDashBorderSpeed;}
float PlayerConst::getDashBlendRange() const {return mDashBlendRange;}
float PlayerConst::getDashFastBorderSpeed() const {return mDashFastBorderSpeed;}
float PlayerConst::getDashFastBlendRange() const {return mDashFastBlendRange;}
float PlayerConst::getAnimFrameRateSpeedMax() const {return mAnimFrameRateSpeedMax;}
float PlayerConst::getAnimFrameRateRunStart() const {return mAnimFrameRateRunStart;}
float PlayerConst::getAnimFrameRateMinRun() const {return mAnimFrameRateMinRun;}
float PlayerConst::getAnimFrameRateMaxRun() const {return mAnimFrameRateMaxRun;}
float PlayerConst::getAnimFrameRateMaxDash() const {return mAnimFrameRateMaxDash;}
float PlayerConst::getAnimFrameRateMaxDashFast() const {return mAnimFrameRateMaxDashFast;}
float PlayerConst::getRunStartPlayFrameScale() const {return mRunStartPlayFrameScale;}
int PlayerConst::getRunStartBlendFrame() const {return mRunStartBlendFrame;}
float PlayerConst::getDamageFireRunAnimRate() const {return mDamageFireRunAnimRate;}
float PlayerConst::getRunSkateAnimSpeedOffset() const {return mRunSkateAnimSpeedOffset;}
float PlayerConst::getAnimFrameRateRange2D() const {return mAnimFrameRateRange2D;}
float PlayerConst::getAnimFrameRateMinRun2D() const {return mAnimFrameRateMinRun2D;}
float PlayerConst::getAnimFrameRateMaxRun2D() const {return mAnimFrameRateMaxRun2D;}
int PlayerConst::getIKBlendFrameRun() const {return mIKBlendFrameRun;}
float PlayerConst::getIKBlendRateRunMin() const {return mIKBlendRateRunMin;}
float PlayerConst::getIKBlendRateRunMax() const {return mIKBlendRateRunMax;}
float PlayerConst::getRollingAnimBorderSpeedMin() const {return mRollingAnimBorderSpeedMin;}
float PlayerConst::getRollingAnimBorderSpeedMax() const {return mRollingAnimBorderSpeedMax;}
float PlayerConst::getRollingAnimFrameRateMin() const {return mRollingAnimFrameRateMin;}
float PlayerConst::getRollingAnimFrameRateMax() const {return mRollingAnimFrameRateMax;}
int PlayerConst::getSwimPaddleAnimInterval() const {return mSwimPaddleAniminterval;}
int PlayerConst::getSwimPaddleAnimRateIntervalMax() const {return mSwimPaddleAnimRateintervalMax;}
int PlayerConst::getSwimPaddleAnimRateIntervalMin() const {return mSwimPaddleAnimRateintervalMin;}
float PlayerConst::getSwimPaddleAnimMaxRate() const {return mSwimPaddleAnimMaxRate;}
float PlayerConst::getSwimBentForwardMax() const {return mSwimBentForwardMax;}
float PlayerConst::getSwimBentForwardBlendRate() const {return mSwimBentForwardBlendRate;}
float PlayerConst::getSwimBentSideMax() const {return mSwimBentSideMax;}
float PlayerConst::getSwimBentSpineMax() const {return mSwimBentSpineMax;}
float PlayerConst::getSwimBentSideBlendRate() const {return mSwimBentSideBlendRate;}
float PlayerConst::getSwimBentFrontMax() const {return mSwimBentFrontMax;}
float PlayerConst::getSwimBentFrontBlendRate() const {return mSwimBentFrontBlendRate;}
float PlayerConst::getSwimWalkAnimSpeedMax() const {return mSwimWalkAnimSpeedMax;}
float PlayerConst::getSwimWalkAnimSpeedMin() const {return mSwimWalkAnimSpeedMin;}
float PlayerConst::getSwimWalkAnimFrameRateMax() const {return mSwimWalkAnimFrameRateMax;}
float PlayerConst::getSwimWalkAnimFrameRateMin() const {return mSwimWalkAnimFrameRateMin;}
float PlayerConst::getSandSinkBorderMin() const {return mSandSinkBorderMin;}
float PlayerConst::getSandSinkBorderMax() const {return mSandSinkBorderMax;}
float PlayerConst::getSandSinkBorderRateMin() const {return mSandSinkBorderRateMin;}
float PlayerConst::getSandSinkBorderRateMax() const {return mSandSinkBorderRateMax;}
float PlayerConst::getSandSinkFrameRateMin() const {return mSandSinkFrameRateMin;}
float PlayerConst::getSandSinkFrameRateMax() const {return mSandSinkFrameRateMax;}
int PlayerConst::getLookAtEyeKeepFrame() const {return mLookAtEyeKeepFrame;}
int PlayerConst::getLookAtEyeKeepFrameInSight() const {return mLookAtEyeKeepFrameInSight;}
int PlayerConst::getLookAtEyeKeepFrameWait() const {return mLookAtEyeKeepFrameWait;}
float PlayerConst::getLookAtEyeDistance() const {return mLookAtEyeDistance;}
float PlayerConst::getLookAtEyeAngleMinH() const {return mLookAtEyeAngleMinH;}
float PlayerConst::getLookAtEyeAngleMinInSightH() const {return mLookAtEyeAngleMinInSightH;}
float PlayerConst::getLookAtEyeAngleMaxH() const {return mLookAtEyeAngleMaxH;}
float PlayerConst::getLookAtEyeAngleMinV() const {return mLookAtEyeAngleMinV;}
float PlayerConst::getLookAtEyeAngleMinInSightV() const {return mLookAtEyeAngleMinInSightV;}
float PlayerConst::getLookAtEyeAngleMaxV() const {return mLookAtEyeAngleMaxV;}
float PlayerConst::getTiltEyeBorderStart() const {return mTiltEyeBorderStart;}
float PlayerConst::getTiltEyeBorderEnd() const {return mTiltEyeBorderEnd;}
float PlayerConst::getTiltEyeAngleScale() const {return mTiltEyeAngleScale;}
float PlayerConst::getCenterTiltRateMax() const {return mCenterTiltRateMax;}
float PlayerConst::getNoseChildLocalOffset() const {return mNoseChildLocalOffset;}
float PlayerConst::getNoseStability() const {return mNoseStability;}
float PlayerConst::getNoseFriction() const {return mNoseFriction;}
float PlayerConst::getNoseLimitDegree() const {return mNoseLimitDegree;}
float PlayerConst::getMustacheChildLocalOffset() const {return mMustacheChildLocalOffset;}
float PlayerConst::getMustacheStability() const {return mMustacheStability;}
float PlayerConst::getMustacheFriction() const {return mMustacheFriction;}
float PlayerConst::getMustacheLimitDegree() const {return mMustacheLimitDegree;}
int PlayerConst::getCapInterpolateFrame() const {return mCapinterpolateFrame;}
float PlayerConst::getCapChildLocalOffset() const {return mCapChildLocalOffset;}
float PlayerConst::getCapStability() const {return mCapStability;}
float PlayerConst::getCapFriction() const {return mCapFriction;}
float PlayerConst::getCapLimitDegree() const {return mCapLimitDegree;}
float PlayerConst::getCapTransStability() const {return mCapTransStability;}
float PlayerConst::getCapTransFriction() const {return mCapTransFriction;}
float PlayerConst::getCapTransLimit() const {return mCapTransLimit;}
int PlayerConst::getCapManHeroEyesWaitAppearFrame() const {return mCapManHeroEyesWaitAppearFrame;}
int PlayerConst::getDeadWipeStartDamage() const {return mDeadWipeStartDamage;}
int PlayerConst::getDeadWipeWaitDamage() const {return mDeadWipeWaitDamage;}
int PlayerConst::getDeadWipeStartAbyss() const {return mDeadWipeStartAbyss;}
int PlayerConst::getDeadWipeWaitAbyss() const {return mDeadWipeWaitAbyss;}
int PlayerConst::getDeadWipeStartAbyssWithCapMsg() const {return mDeadWipeStartAbyssWithCapMsg;}
int PlayerConst::getDeadWipeWaitAbyssWithCapMsg() const {return mDeadWipeWaitAbyssWithCapMsg;}
int PlayerConst::getDeadWipeStartPress() const {return mDeadWipeStartPress;}
int PlayerConst::getDeadWipeWaitPress() const {return mDeadWipeWaitPress;}
int PlayerConst::getDeadWipeStartSandSink() const {return mDeadWipeStartSandSink;}
int PlayerConst::getDeadWipeWaitSandSink() const {return mDeadWipeWaitSandSink;}
int PlayerConst::getDeadWipeStartNoOxygen() const {return mDeadWipeStartNoOxygen;}
int PlayerConst::getDeadWipeWaitNoOxygen() const {return mDeadWipeWaitNoOxygen;}
int PlayerConst::getDeadWipeStartIceWater() const {return mDeadWipeStartIceWater;}
int PlayerConst::getDeadWipeWaitIceWater() const {return mDeadWipeWaitIceWater;}
float PlayerConst::getCoinDashSpeed() const {return mCoinDashSpeed;}
float PlayerConst::getCoinDashSpeedLimit() const {return mCoinDashSpeedLimit;}
float PlayerConst::getAdditionalSpeedLimit() const {return mAdditionalSpeedLimit;}
