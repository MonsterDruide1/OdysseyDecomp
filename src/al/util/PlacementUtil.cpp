...
namespace al
{
    ...
    void getPlacementInfoByKey(al::PlacementInfo *pOutInfo, const al::PlacementInfo &rInfo, const char *pKey)
    {
    ...
    bool tryGetPlacementInfoByIndex(al::PlacementInfo *pOutInfo, const al::PlacementInfo &rInfo, int idx)
    {
        bool result;
    ...
    void getPlacementInfoAndKeyNameByIndex(al::PlacementInfo *pOutInfo, const char **pOutKeyName, const al::PlacementInfo &rInfo, int idx)
    {
        al::ByamlIter iterator;
    ...
    bool tryGetPlacementInfoAndKeyNameByIndex(al::PlacementInfo *pOutInfo, const char **pOutKeyName, const al::PlacementInfo &rInfo, int idx)
    {
        bool result;
