...
PlayerInput::PlayerInput(const al::LiveActor*, const IUsePlayerCollision*, const IUseDimension*){} //FIXME remove this

bool PlayerInput::isEnableCarry() const {
    if(mDisableInput)
        return false;

    return PlayerInputFunction::isHoldAction(mLiveActor, PlayerFunction::getPlayerInputPort(mLiveActor));
}
...
bool PlayerInput::isTriggerCarryStart() const {
    ...
    return PlayerInputFunction::isTriggerAction(mLiveActor, PlayerFunction::getPlayerInputPort(mLiveActor));
}
...
bool PlayerInput::isTriggerCarryRelease() const {
    ...
    if(PlayerInputFunction::isTriggerAction(mLiveActor, PlayerFunction::getPlayerInputPort(mLiveActor)))
        return true;
...
bool PlayerInput::isTriggerJump() const {
    ...
    return PlayerInputFunction::isTriggerJump(mLiveActor, PlayerFunction::getPlayerInputPort(mLiveActor));
}

bool PlayerInput::isTriggerHipDrop() const {
    if(mDisableInput)
        return false;
    return PlayerInputFunction::isTriggerSubAction(mLiveActor, PlayerFunction::getPlayerInputPort(mLiveActor));
}
...
bool PlayerInput::isTriggerRolling(bool a1) const {
    if(mDisableInput)
        return false;
    if(!PlayerInputFunction::isHoldSubAction(mLiveActor, PlayerFunction::getPlayerInputPort(mLiveActor)) && !a1)
        return false;
    if(PlayerInputFunction::isTriggerAction(mLiveActor, PlayerFunction::getPlayerInputPort(mLiveActor)))
        return true;
    if(mDisableInput)
...
bool PlayerInput::isHoldJump() const {
    ...
    return PlayerInputFunction::isHoldJump(mLiveActor, PlayerFunction::getPlayerInputPort(mLiveActor));
}
...
bool PlayerInput::isTriggerStartTalk() const {
    if(mDisableInput)
        return false;
    return PlayerInputFunction::isTriggerTalk(mLiveActor, PlayerFunction::getPlayerInputPort(mLiveActor));
}

bool PlayerInput::isTriggerStartWorldWarp() const {
    if(mDisableInput)
        return false;
    return PlayerInputFunction::isTriggerStartWorldWarp(mLiveActor, PlayerFunction::getPlayerInputPort(mLiveActor));
}

bool PlayerInput::isTriggerCancelWorldWarp() const {
    if(mDisableInput)
        return false;
    return PlayerInputFunction::isTriggerCancelWorldWarp(mLiveActor, PlayerFunction::getPlayerInputPort(mLiveActor));
}
...
bool PlayerInput::isReleaseJump() const {
    if(mDisableInput)
        return false;
    return PlayerInputFunction::isReleaseJump(mLiveActor, PlayerFunction::getPlayerInputPort(mLiveActor));
}

bool PlayerInput::isReleaseHackAction() const {
    if(mDisableInput)
        return false;
    return PlayerInputFunction::isReleaseAction(mLiveActor, PlayerFunction::getPlayerInputPort(mLiveActor));
}
