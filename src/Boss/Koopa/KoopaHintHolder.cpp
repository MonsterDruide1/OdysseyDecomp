...
KoopaBombHintRequestInfo::KoopaBombHintRequestInfo() : mIsRequested(false) {}
...
bool KoopaHintHolder::tryAppearMessageDamage(s32 damageType) {
    ...
    al::StringTmp<64> label("Koopa_Damage_%d", damageType);
    rs::showCapMessageBossDamage(sceneObjHolder, label.cstr(), 30, 30);
...
al::SceneObjHolder* KoopaHintHolder::getSceneObjHolder() const {
