...
void ChurchDoor::init(const al::ActorInitInfo& info) {
    ...
    // weirdness with this ? this : nullptr required to generate csel with xzr (upcast)
    if (al::isEqualString("MoonWorldWeddingRoomStage",
                          GameDataFunction::getCurrentStageName(this ? this : nullptr))) {
