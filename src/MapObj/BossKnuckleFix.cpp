...
void BossKnuckleFix::init(const al::ActorInitInfo& info) {
    ...
    const char* moveLimitName = "MoveLimit";
    mCollisionObj = new al::CollisionObj(info, al::getModelResource(this), moveLimitName,
                                         al::getHitSensor(this, "Body"), nullptr, nullptr);
    al::setCollisionPartsSpecialPurposeName(mCollisionObj, moveLimitName);
...
bool BossKnuckleFix::receiveMsg(const al::SensorMsg* message, al::HitSensor* other,
    ...
    if (al::isNerve(this, &NrvBossKnuckleFix.Wait) &&
        ...
        s32 reactionCount = mReactionCount;
        mReactionCount = reactionCount + 1;
