...
const f32 sFallScale = 0.99f;
const f32 sFallGravityByMeteor = 0.6f;
const f32 sFallScaleByMeteor = 0.995f;

const f32* const sFallParams[] = {&sFallGravity, &sFallScale};
const f32* const sFallParamsByMeteor[] = {&sFallGravityByMeteor, &sFallScaleByMeteor};
}  // namespace
...
void MoonBasementFloor::init(const al::ActorInitInfo& info) {
    ...
    f32 random = al::getRandom(0.0f, 3.99f);
    s32 randomInt = random;
    s32 roundAdjust;
    ...
    f32 rotate = roundAdjust + randomInt;
...
void MoonBasementFloor::exeFall() {
    ...
    const f32* const* params =
        al::isNerve(this, &NrvMoonBasementFloor.FallByMeteor) ? sFallParamsByMeteor : sFallParams;
    al::addVelocityToGravity(this, *params[0]);

    params =
        al::isNerve(this, &NrvMoonBasementFloor.FallByMeteor) ? sFallParamsByMeteor : sFallParams;
    al::scaleVelocity(this, *params[1]);
