...
public:
    ...
    static SaveObjInfo* createSaveObjInfoNoWriteSaveDataInSameWorld(const al::ActorInitInfo& initInfo,
                                                            const al::PlacementId* placementId);
    static SaveObjInfo*
    createSaveObjInfoNoWriteSaveDataInSameWorldResetMiniGame(const al::ActorInitInfo& initInfo,
                                                             const al::PlacementId* placementId);
    static SaveObjInfo* createSaveObjInfoNoWriteSaveDataInSameScenario(const al::ActorInitInfo& initInfo,
                                                               const al::PlacementId* placementId);
