...
public:
    ...
    GameProgressData(const WorldList*);
    void init();
    void updateList();
    void checkAndChangeCorrectStatus(s32, s32);
    ...
    bool isUnlockWorld(s32) const;
    s32 getWorldIdForWorldMap(s32) const;
    s32 calcNextLockedWorldNumForWorldMap() const;
    s32 calcNextLockedWorldIdForWorldMap(s32) const;
    bool isUnlockFirstForest() const;
    bool isUnlockFirstSea() const;
    s32 getWorldIdForWorldWarpHole(s32) const;
    s32 getWorldIdForShineList(s32) const;
    s32 calcWorldNumForShineList() const;
    bool isAlreadyGoWorld(s32) const;
    void unlockNextWorld(s32);
    void unlockForest();
    void unlockLake();
    void unlockSnow();
    void unlockSea();
    void unlockNormalWorld();
    bool isFirstTimeGoWorld(s32) const;
    void setAlreadyGoWorld(s32);
    bool isTalkedCapNearHomeInWaterfall() const;
    void talkCapNearHomeInWaterfall();
    void initList();
    s32 calcWorldIdByOrderUnlock(s32) const;
