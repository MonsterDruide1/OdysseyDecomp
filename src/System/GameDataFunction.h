...
SessionEventProgress getSessionEventProgress(GameDataHolderAccessor accessor);
...
sead::Vector3f* getCheckpointTransInWorld(GameDataHolderAccessor accessor, s32 checkpointIdx);
const char* getCheckpointObjIdInWorld(GameDataHolderAccessor accessor, s32 checkpointIdx);
sead::Vector3f* getCheckpointTransInWorld(GameDataHolderAccessor accessor, const char* objId);
...
s32 getCheckpointWarpObjId(GameDataHolderAccessor accessor);
...
sead::Vector3f* calcHintTrans(GameDataHolderAccessor accessor, s32 hintIdx);
sead::Vector3f* getLatestHintTrans(GameDataHolderAccessor accessor);
...
sead::Vector3f* calcHintMoonRockTrans(GameDataHolderAccessor accessor, s32 hintIdx);
void initializeHintList(GameDataHolderWriter writer);
sead::Vector3f* calcHintTransMostEasy(GameDataHolderAccessor accessor);
...
const char* tryGetWorldName(const al::LayoutActor* layout, s32 worldId);
const char* tryGetWorldNameCurrent(const al::LayoutActor* layout);
const char* tryGetRegionNameCurrent(const al::LayoutActor* layout);
...
const char* tryGetWorldNameByFileId(const al::LayoutActor* layout, s32 fileId);
...
sead::PtrArray<ShopItem::ItemInfo>* getShopItemInfoList(GameDataHolderAccessor accessor);
bool isExistHackObjInfo(GameDataHolderAccessor accessor, const char* hackName);
HackObjInfo* getHackObjInfo(GameDataHolderAccessor accessor, const char* hackName);
...
void findShineTrans(sead::Vector3f* trans, GameDataHolderAccessor accessor, s32 worldId,
                    s32 shineIdx);
sead::Vector3f* getHomeTrans(GameDataHolderAccessor accessor);
...
sead::Vector3f* getMiniGameTrans(GameDataHolderAccessor accessor, s32 miniGameIdx);
const char* getMiniGameName(GameDataHolderAccessor accessor, s32 miniGameIdx);
sead::Vector3f* getRaceStartTrans(GameDataHolderAccessor accessor);
sead::Vector3f* getRaceGoalTrans(GameDataHolderAccessor accessor);
sead::Vector3f* getHintNpcTrans(GameDataHolderAccessor accessor);
sead::Vector3f* getShopNpcTrans(GameDataHolderAccessor accessor, s32 shopNpcIdx);
...
sead::Matrix34f* getCurrentMapView(GameDataHolderAccessor accessor);
bool isExistJango(GameDataHolderAccessor accessor);
sead::Vector3f* getJangoTrans(GameDataHolderAccessor accessor);
bool isExistAmiiboNpc(GameDataHolderAccessor accessor);
sead::Vector3f* getAmiiboNpcTrans(GameDataHolderAccessor accessor);
bool isInInvalidOpenMapStage(GameDataHolderAccessor accessor);
sead::Vector3f* getStageMapPlayerPos(GameDataHolderAccessor accessor);
bool isExistTimeBalloonNpc(GameDataHolderAccessor accessor);
sead::Vector3f* getTimeBalloonNpcTrans(GameDataHolderAccessor accessor);
bool isExistPoetter(GameDataHolderAccessor accessor);
sead::Vector3f* getPoetterTrans(GameDataHolderAccessor accessor);
sead::Vector3f* getMoonRockTrans(GameDataHolderAccessor accessor);
...
CollectBgm* getCollectBgmByIndex(GameDataHolderAccessor accessor, s32 bgmIdx);
void trySetCollectedBgm(GameDataHolderWriter writer, const char* resourceName,
                        const char* situationName);
