...
2. **Decompile it** using Hex-Rays or Ghidra.
    ...
    * The [cheatsheet](https://github.com/botw/Cheatsheet.md) (of the BotW project) might help you recognize inline functions.
...
6. **Add the mangled function name to the list of decompiled functions.**
    * To do so, open `data/uking_functions.csv`, search for the name function you have decompiled, and make sure that the mangled function name in the last column matches the decompiled mangled name.
...
8. **Tweak the code to get a perfectly matching function**.
    ...
    * The [cheatsheet](https://github.com/botw/Cheatsheet.md) (of the BotW project) might help you recognize code patterns and contains a checklist for common matching issues.
